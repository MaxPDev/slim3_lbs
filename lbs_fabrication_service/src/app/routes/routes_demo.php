...
use lbs\fab\app\controller\Demo_Controller;
use lbs\fab\app\middleware\ExampleMiddleware;
...
$app->get('/video4_2/{name}[/]', 'lbs\fab\app\controller\Demo_Controller:sayHello');
